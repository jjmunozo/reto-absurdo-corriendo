            ...
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-gray-600 flex items-center gap-1">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs">
                    <p className="text-sm">
                      <strong>R² (Coeficiente de Determinación):</strong> Indica qué porcentaje de la variación en tu pace se explica por la distancia.
                    </p>
                    <p className="text-xs mt-1">
                      • <strong>100%</strong>: La distancia explica todo el cambio en pace<br/>
                      • <strong>50%</strong>: La distancia explica la mitad del cambio<br/>
                      • <strong>0%</strong>: La distancia no explica el cambio en pace
                    </p>
                  </TooltipContent>
                </Tooltip>
              </CardTitle>
