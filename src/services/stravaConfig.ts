...
// URL de redirección dinámica basada en el entorno actual
// Usamos una URL absoluta para evitar problemas con path relativos
export const STRAVA_REDIRECT_URI = window.location.origin + "/auth/strava/callback";

// URL de autenticación de Strava con scope específico
